    ...
    <footer className="bg-black border-t border-white/10 pt-16 pb-8 px-4">
      <div className="max-w-lg mx-auto">
        <div className="flex items-center gap-2 mb-8">
          <div className="w-6 h-6 rounded bg-gradient-to-br from-primary to-accent-purple flex items-center justify-center">
            <span className="material-icons-round text-white text-xs">dataset</span>
          </div>
          <span className="font-display font-bold text-lg text-white">Datalog</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-white/10">
          <p className="text-xs text-gray-600 text-center sm:text-left">© 2023 Datalog AI Inc. All rights reserved.</p>
